# Newgistics tracking  api
Newgistics tracking API and webhook make it easy to integrate Newgistics Tracking function into your own project. Support APIs Client Libraries for PHP

### API key

In order to use this API, you need to generate a Newgistics Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code.  use  Newgistics Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Newgistics Tracking API](https://www.trackingmore.com/newgistics-tracking-api.html)  to:

   *   Get Newgistics realtime tracking info of muti-carriers in one integration
   *   Provide Newgistics shipment tracking experience like Amazon
   *   Push Newgistics  notifications of package update with webhook
   *   Verify Newgistics delivery exception before it is too late
